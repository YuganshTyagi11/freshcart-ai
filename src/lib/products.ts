...
export const PRODUCTS: Product[] = [
  { id: "p1", name: "Fresh Milk", category: "dairy", price: 60, unit: "1L", emoji: "🥛", tag: "Bestseller" },
  ...
  { id: "p5", name: "Red Apples", category: "fruits", price: 180, unit: "1kg", emoji: "🍎", tag: "Fresh" },
  ...
  { id: "p13", name: "Sourdough Bread", category: "bakery", price: 90, unit: "400g", emoji: "🍞", tag: "Fresh today" },
  ...
  { id: "p18", name: "Sparkling Water", category: "beverages", price: 70, unit: "750ml", emoji: "🥤" },
  { id: "p19", name: "Dark Chocolate", category: "snacks", price: 150, unit: "100g", emoji: "🍫", tag: "Vegan" },
